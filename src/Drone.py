...
class Drone:
    def __init__(self):
        ...
        self.pid_controller = PIDController(0.07, 0, 0.04, 4.5)
        self.forward_pid_controller = PIDController(0.9,0, 0.015, 4.5)
        self.narrow_pid_controller = PIDController(0.03,0, 0.03, 4.5)
